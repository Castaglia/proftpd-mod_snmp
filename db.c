...
static struct snmp_field_info snmp_fields[] = {
  ...
  { SNMP_DB_FTPS_LOGINS_F_TOTAL, SNMP_DB_ID_TLS, 24,
    sizeof(uint32_t), "FTPS_LOGINS_F_TOTAL" },
  { SNMP_DB_FTPS_LOGINS_F_ERR_TOTAL, SNMP_DB_ID_TLS, 28,
    sizeof(uint32_t), "FTPS_LOGINS_F_ERR_TOTAL" },
  { SNMP_DB_FTPS_LOGINS_F_ERR_BAD_USER_TOTAL, SNMP_DB_ID_TLS, 32,
    sizeof(uint32_t), "FTPS_LOGINS_F_ERR_BAD_USER_TOTAL" },
  { SNMP_DB_FTPS_LOGINS_F_ERR_BAD_PASSWD_TOTAL, SNMP_DB_ID_TLS, 36,
    sizeof(uint32_t), "FTPS_LOGINS_F_ERR_BAD_PASSWD_TOTAL" },
  { SNMP_DB_FTPS_LOGINS_F_ERR_GENERAL_TOTAL, SNMP_DB_ID_TLS, 40,
    sizeof(uint32_t), "FTPS_LOGINS_F_ERR_GENERAL_TOTAL" },
  { SNMP_DB_FTPS_LOGINS_F_CERT_TOTAL, SNMP_DB_ID_TLS, 44,
    sizeof(uint32_t), "FTPS_LOGINS_F_CERT_TOTAL" },

  /* ftps.tlsDataTransfers fields */
  { SNMP_DB_FTPS_XFERS_F_DIR_LIST_COUNT, SNMP_DB_ID_TLS, 48,
    sizeof(uint32_t), "FTPS_XFERS_F_DIR_LIST_COUNT" },
  { SNMP_DB_FTPS_XFERS_F_DIR_LIST_TOTAL, SNMP_DB_ID_TLS, 52,
    sizeof(uint32_t), "FTPS_XFERS_F_DIR_LIST_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_DIR_LIST_ERR_TOTAL, SNMP_DB_ID_TLS, 56,
    sizeof(uint32_t), "FTPS_XFERS_F_DIR_LIST_ERR_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_FILE_UPLOAD_COUNT, SNMP_DB_ID_TLS, 60,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_UPLOAD_COUNT" },
  { SNMP_DB_FTPS_XFERS_F_FILE_UPLOAD_TOTAL, SNMP_DB_ID_TLS, 64,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_UPLOAD_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_FILE_UPLOAD_ERR_TOTAL, SNMP_DB_ID_TLS, 68,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_UPLOAD_ERR_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_FILE_DOWNLOAD_COUNT, SNMP_DB_ID_TLS, 72,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_DOWNLOAD_COUNT" },
  { SNMP_DB_FTPS_XFERS_F_FILE_DOWNLOAD_TOTAL, SNMP_DB_ID_TLS, 76,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_DOWNLOAD_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_FILE_DOWNLOAD_ERR_TOTAL, SNMP_DB_ID_TLS, 80,
    sizeof(uint32_t), "FTPS_XFERS_F_FILE_DOWNLOAD_ERR_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_KB_UPLOAD_TOTAL, SNMP_DB_ID_TLS, 84,
    sizeof(uint32_t), "FTPS_XFERS_F_KB_UPLOAD_TOTAL" },
  { SNMP_DB_FTPS_XFERS_F_KB_DOWNLOAD_TOTAL, SNMP_DB_ID_TLS, 88,
...
static struct snmp_db_info snmp_dbs[] = {
   ...
   *  11 data transfer fields x 4 bytes = 44 bytes
   *
   * for a total of 92 bytes.
   */
  { SNMP_DB_ID_TLS, -1, "tls.dat", NULL, NULL, 92 },
