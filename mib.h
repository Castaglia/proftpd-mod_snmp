...
#define SNMP_MIB_CONN_OID_SERVER_ADDR_TYPE	SNMP_CONN_OID_BASE, 2
#define SNMP_MIB_CONN_OIDLEN_SERVER_ADDR_TYPE	SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_SERVER_ADDR		SNMP_CONN_OID_BASE, 3
#define SNMP_MIB_CONN_OIDLEN_SERVER_ADDR	SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_SERVER_PORT		SNMP_CONN_OID_BASE, 4
#define SNMP_MIB_CONN_OIDLEN_SERVER_PORT	SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_CLIENT_ADDR_TYPE	SNMP_CONN_OID_BASE, 5
#define SNMP_MIB_CONN_OIDLEN_CLIENT_ADDR_TYPE	SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_CLIENT_ADDR		SNMP_CONN_OID_BASE, 6
#define SNMP_MIB_CONN_OIDLEN_CLIENT_ADDR	SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_PID			SNMP_CONN_OID_BASE, 7
#define SNMP_MIB_CONN_OIDLEN_PID		SNMP_CONN_OID_BASELEN + 1

#define SNMP_MIB_CONN_OID_USER_NAME		SNMP_CONN_OID_BASE, 8
