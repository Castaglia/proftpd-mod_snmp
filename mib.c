...
static struct snmp_mib snmp_mibs[] = {
  ...
  { { SNMP_MIB_SSH_AUTH_OID_HOSTBASED_COUNT, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_HOSTBASED_COUNT,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_HOSTBASED_TOTAL, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_HOSTBASED_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.hostbasedAuthTotal",
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.hostbasedAuthTotal.0",
    SNMP_SMI_COUNTER32 },

  { { SNMP_MIB_SSH_AUTH_OID_HOSTBASED_ERR_TOTAL, 0 },
    SNMP_MIB_SSH_AUTH_OIDLEN_HOSTBASED_ERR_TOTAL + 1,
    SNMP_DB_SSH_AUTH_F_HOSTBASED_ERR_TOTAL,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_KBDINT_COUNT, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_KBDINT_COUNT,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_KBDINT_TOTAL, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_KBDINT_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.keyboardInteractiveAuthTotal",
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.keyboardInteractiveAuthTotal.0",
    SNMP_SMI_COUNTER32 },

  { { SNMP_MIB_SSH_AUTH_OID_KBDINT_ERR_TOTAL, 0 },
    SNMP_MIB_SSH_AUTH_OIDLEN_KBDINT_ERR_TOTAL + 1,
    SNMP_DB_SSH_AUTH_F_KBDINT_ERR_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.keyboardInteractiveAuthFailureTotal",
  ...
  { { SNMP_MIB_SSH_AUTH_OID_PASSWD_COUNT, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_PASSWD_COUNT,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_PASSWD_TOTAL, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_PASSWD_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.passwordAuthTotal",
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.passwordAuthTotal.0",
    SNMP_SMI_COUNTER32 },

  { { SNMP_MIB_SSH_AUTH_OID_PASSWD_ERR_TOTAL, 0 },
    SNMP_MIB_SSH_AUTH_OIDLEN_PASSWD_ERR_TOTAL + 1,
    SNMP_DB_SSH_AUTH_F_PASSWD_ERR_TOTAL,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_PUBLICKEY_COUNT, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_PUBLICKEY_COUNT,
  ...
  { { SNMP_MIB_SSH_AUTH_OID_PUBLICKEY_TOTAL, 0 },
    ...
    SNMP_DB_SSH_AUTH_F_PUBLICKEY_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.publickeyAuthTotal",
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.publickeyAuthTotal.0",
    SNMP_SMI_COUNTER32 },

  { { SNMP_MIB_SSH_AUTH_OID_PUBLICKEY_ERR_TOTAL, 0 },
    SNMP_MIB_SSH_AUTH_OIDLEN_PUBLICKEY_ERR_TOTAL + 1,
    SNMP_DB_SSH_AUTH_F_PUBLICKEY_ERR_TOTAL,
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.publickeyAuthFailureTotal",
    SNMP_MIB_NAME_PREFIX "ssh.sshSessions.sshAuth.publickeyAuthFailureTotal.0",
    SNMP_SMI_COUNTER32 },

  /* ssh.sshSessions MIBs */
  { { SNMP_MIB_SSH_SESS_OID_KEX_ERR_TOTAL, 0 },
    SNMP_MIB_SSH_SESS_OIDLEN_KEX_ERR_TOTAL + 1,
    SNMP_DB_SSH_SESS_F_KEX_ERR_TOTAL,
  ...
  { { SNMP_MIB_SSH_SESS_OID_COMPRESS_COUNT, 0 },
    ...
    SNMP_DB_SSH_SESS_F_COMPRESS_COUNT,
  ...
  { { SNMP_MIB_SSH_SESS_OID_COMPRESS_TOTAL, 0 },
    ...
    SNMP_DB_SSH_SESS_F_COMPRESS_TOTAL,
  ...
  { { SNMP_MIB_SSH_LOGINS_OID_TOTAL, 0 },
    ...
    SNMP_DB_SSH_LOGINS_F_LOGIN_TOTAL,
  ...
  { { SNMP_MIB_SSH_LOGINS_OID_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SSH_LOGINS_F_LOGIN_ERR_TOTAL,
  ...
  { { SNMP_MIB_SFTP_SESS_OID_COUNT, 0 },
    ...
    SNMP_DB_SFTP_SESS_F_SESS_COUNT,
  ...
  { { SNMP_MIB_SFTP_SESS_OID_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_SESS_F_SESS_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_DIR_LIST_COUNT, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_DIR_LIST_COUNT,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_DIR_LIST_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_DIR_LIST_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_DIR_LIST_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_DIR_LIST_ERR_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_UPLOAD_COUNT, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_UPLOAD_COUNT,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_UPLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_UPLOAD_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_UPLOAD_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_UPLOAD_ERR_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_DOWNLOAD_COUNT, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_DOWNLOAD_COUNT,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_DOWNLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_DOWNLOAD_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_FILE_DOWNLOAD_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_FILE_DOWNLOAD_ERR_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_KB_UPLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_KB_UPLOAD_TOTAL,
  ...
  { { SNMP_MIB_SFTP_XFERS_OID_KB_DOWNLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SFTP_XFERS_F_KB_DOWNLOAD_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_UPLOAD_COUNT, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_UPLOAD_COUNT,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_UPLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_UPLOAD_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_UPLOAD_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_UPLOAD_ERR_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_DOWNLOAD_COUNT, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_DOWNLOAD_COUNT,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_DOWNLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_DOWNLOAD_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_FILE_DOWNLOAD_ERR_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_FILE_DOWNLOAD_ERR_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_KB_UPLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_KB_UPLOAD_TOTAL,
  ...
  { { SNMP_MIB_SCP_XFERS_OID_KB_DOWNLOAD_TOTAL, 0 },
    ...
    SNMP_DB_SCP_XFERS_F_KB_DOWNLOAD_TOTAL,
